  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
     ...
     BeyondNow Reverse Recruiting{' '}
      ...
      BeyondNow Reverse Recruiting: U.S.-based Reverse Recruiters manage your ServiceNow job search from discovery to interview. Handpicked jobs, tailored resumes, and strategic networking—all with live chat and optional weekly strategy calls.      <div className="mt-10 flex justify-center gap-x-6">
