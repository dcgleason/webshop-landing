...
export function Hero() {
  return (
   ...
   Find and land your ServiceNow{' '}
     ...
     BeyondNow is a U.S.-based career coaching agency that guides you through your ServiceNow job search by offering up proven-to-work strategies around online networking and resume-building specific to the ServiceNow space. 
      </p>
