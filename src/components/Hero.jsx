    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
     ...
     BeyondNow Reverse Recruiting{' '}
        <span className="relative whitespace-nowrap text-[#235373]">
          ...
          <span className="relative">(built for ServiceNow Professionals)</span>
        </span>{' '}
       
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      Elevate your ServiceNow career with BeyondNow JobFinder Pro. From personalized job recommendations to landing interviews, our dedicated consultants manage your job search end-to-end. Resume optimization, LinkedIn branding, interview prep, and salary negotiation—We've got it all covered.
