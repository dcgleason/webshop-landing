...
export function Hero() {
  return (
   ...
   Level {' '}
     ...
     BeyondNow is a U.S.-based, career coaching firm that utilizes advice & knowledge from expert ServiceNow engineers and community-based support to level up in your career faster. 
      </p>
