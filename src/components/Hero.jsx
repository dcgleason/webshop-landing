...
export function Hero() {
  return (
    ...
    Looking to land your ServiceNow{' '}
     ...
     Stop looking and start finding! BeyondNow LLC is a U.S.-based career consulting firm that coaches you on how to effectively network to land referrals in the ServiceNow space.  
      </p>
