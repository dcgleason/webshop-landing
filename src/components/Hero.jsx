    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
     ...
     BeyondNow Reverse Recruiting{' '}
        <span className="relative whitespace-nowrap text-[#235373]">
          ...
          <span className="relative">(built for ServiceNow job-seekers)</span>
        </span>{' '}
       
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      BeyondNow Reverse Recruiting: U.S.-based, fully managed job search service that helps you land your dream ServiceNow job. Handpicked jobs personalized to your criteria, resume optimization, and strategic networking done on your behalf to your companies of choice.      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-[#235373] group-active:fill-current"
          >
