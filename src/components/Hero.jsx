...
export function Hero() {
  return (
   ...
   Find and land your ServiceNow{' '}
     ...
     BeyondNow is a U.S.-based reverse recruitment agency that guides you through your ServiceNow job search by offering networking tips & tricks and applying to jobs ideal to you.   
      </p>
