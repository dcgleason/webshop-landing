...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <em>Level up</em> your career in ServiceNow with weekly masterminds with experienced Sr. SN devs that&apos;ll help you get unstuck, a cool app that literally applies to jobs for you, and coursework that gives you information you won&apos;t find elsewhere. 
      </p>
