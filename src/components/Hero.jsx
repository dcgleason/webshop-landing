...
export function Hero() {
  return (
   ...
   Level {' '}
     ...
     BeyondNow is a U.S.-based, career coaching firm for ServiceNow professionals that provides advice and hard-to-aquire knowledge from expert ServiceNow engineers in the form of community-based support, to level up in your career faster. 
      </p>
