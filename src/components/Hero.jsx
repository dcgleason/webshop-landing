...
export function Hero() {
  return (
   ...
   Find and land your ServiceNow{' '}
     ...
     BeyondNow is a U.S.-based, reverse recruiting agency that uses online community support and sage advice from expert ServiceNow engineers to land you your dream ServiceNow job. 
      </p>
