...
export function Hero() {
  return (
    ...
    Looking for your SN{' '}
     ...
     Stop looking and start finding! BeyondNow LLC optimizations your resume & LinkedIn profile, networks for you at companies of your choice, and applies to hand-picked ServiceNow jobs you approve of on your behalf.  
      </p>
