...
export function Hero() {
  return (
   ...
   Find and land your ServiceNow{' '}
     ...
     BeyondNow is a U.S.-based, reverese recruiting agency that supports you through your job search process by offering proven-to-work strategies around online networking and resume-building specific to the ServiceNow space and applies to jobs for you. 
      </p>
        <div className="mt-10 flex justify-center gap-x-6">
        <Button href="#pricing">Join the community today</Button>
        {/* <Button
