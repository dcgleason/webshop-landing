...
export function Hero() {
  return (
    ...
    Looking for your SN{' '}
     ...
     Stop looking and start finding! BeyondNow LLC is a reverse recruitment firm that optimizations your resume & LinkedIn profile, networks with key decision makers for you at companies of your choice, and applies to hand-picked ServiceNow jobs you approve of on your behalf.  
      </p>
