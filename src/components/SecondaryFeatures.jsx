...
const features = [
  {
    ...
    description:
      "We're not happy until you're thrilled. That we offer unlimited revisions ensures that you get exactly what you envisioned.",
  ...
  },
  {
    ...
    summary:
      'We deliver each of your requests 1-2 business days.',
    description:
    ...
    >
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          Results-oriented, responsive, reliable - no meetings.  
          </h2>
