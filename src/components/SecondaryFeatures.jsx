...
const features = [
  {
    ...
    description: "Your dedicated Reverse Recruiter will give you tools and tips to improve your resume & LinkedIn profile so that you differentiate you from the crowd.",
